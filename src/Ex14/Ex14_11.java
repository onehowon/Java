...
public class Ex14_11{
    public static void main(String[] args){
        Student3[] stuArr = {
            ...
            new Student3("김자바", true, 1, 2, 250),
            new Student3("박자바", false, 1, 1, 270),
            new Student3("윤자바", false, 1, 3, 50),
            new Student3("신자바", true, 1, 2, 100),
            new Student3("유자바", false, 1, 3, 200),
            new Student3("양자바", true, 2, 1, 300),
            new Student3("강자바", true, 2, 2, 250),
            new Student3("안자바", false, 2, 3, 200),
            new Student3("킹자바", true, 2, 1, 220),
            new Student3("산자바", false, 2, 2, 300),
            new Student3("광자바", true, 2, 3, 200)
        };
